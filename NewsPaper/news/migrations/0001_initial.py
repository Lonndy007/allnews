    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_of_news', models.TextField()),
                ('rate_of_news', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text_of_comm', models.CharField(max_length=800)),
                ('time_of_comm', models.DateTimeField(auto_now_add=True)),
                ('rate_of_comm', models.IntegerField(default=0)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='news.post')),
